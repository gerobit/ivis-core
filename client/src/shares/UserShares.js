...
export default class UserShares extends Component {
    ...
    render() {
        ...
        const sharesTableElement = em.get('app.share.table.entities', [{entityTypeId: 'namespace', label:'Namespaces'},
         {entityTypeId:'template', label:'Templates'}]).map(entry => 
            renderSharesTable(entry.entityTypeId, t(entry.label)));
